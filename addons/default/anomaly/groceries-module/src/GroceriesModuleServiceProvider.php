...
class GroceriesModuleServiceProvider extends AddonServiceProvider
{
    ...
    protected $routes = [
        ...
        'groceries/show/{id}' => [
            'as' => 'anomaly.module.groceries::groceries.show',
            'uses' => 'Anomaly\GroceriesModule\Http\Controller\GroceriesController@read',
            'middleware' => 'Anomaly\GroceriesModule\Http\Middleware\AuthMiddleware',
        ],
        'groceries/create' => [
            'as' => 'anomaly.module.groceries::groceries.create',
            'uses' => 'Anomaly\GroceriesModule\Http\Controller\GroceriesController@create',
            'middleware' => 'Anomaly\GroceriesModule\Http\Middleware\AuthMiddleware',
        ],
        'groceries/edit/{id}' => [
            'as' => 'anomaly.module.groceries::groceries.edit',
            'uses' => 'Anomaly\GroceriesModule\Http\Controller\GroceriesController@edit',
            'middleware' => 'Anomaly\GroceriesModule\Http\Middleware\AuthMiddleware',
        ],
        'groceries/delete/{id}' => [
            'uses' => 'Anomaly\GroceriesModule\Http\Controller\GroceriesController@delete',
            'middleware' => 'Anomaly\GroceriesModule\Http\Middleware\AuthMiddleware',
        ],
